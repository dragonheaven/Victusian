...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/dash_assets/layouts/layout2/css/layout.min.css">

    <body style="background: url('/images/signup/back_tile.jpg') repeat 50% 0; background-size: 168px 224px;">
