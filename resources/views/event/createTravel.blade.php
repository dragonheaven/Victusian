                                                            ...
                                                            <ul class="list-unstyled">
                                                                <li>
                                                                    <label>
                                                                        ...
                                                                        <input type="radio" name="category[]" value="10">Sport trip</label>
                                                                </li>
                                                                <li>
                                                                    <label>
                                                                        <input type="radio" name="category[]" value="11">Recreational Trip</label>
                                                                </li>
                                                                <li>
                                                                    <label>
                                                                        <input type="radio" name="category[]" value="12">Yoga & Meditational Travel</label>
                                                                </li>
                                                                <li>
                                                                    <label>
                                                                        <input type="radio" name="category[]" value="13">Soulcation Travel</label>
                                                                </li>
                                                            </ul>
                                                        </div>
