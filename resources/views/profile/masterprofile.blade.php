                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light " id="form_wizard_1">
                        ...
                        <div class="portlet-body form">
                            <form action="{{url('/profile/createMasterProfile')}}" class="form-horizontal" id="submit_form" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                    ...
                                    <div class="form-body">
                                        <ul class="nav nav-pills nav-justified steps">
                                            ...
                                            <li>
                                                <a href="#tab3" data-toggle="tab" class="step">
                                                    ...
                                                    <span class="desc">
                                                        <i class="fa fa-check"></i> Local Legion </span>
                                                </a>
                                            </li>
                                            <li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="tab3">
                                                ...
                                                <input type="hidden" name="legionindex" value="none">
                                                <div class="row m-heading-1 border-green m-bordered" id="1">
                                                    <div class="col-sm-2">
                                                        <img src="/images/avatar/avatar.png" class="legion-avatar">
                                                    </div>
                                                    <div class="col-sm-7">
                                                        <h4>Jhon Doe</h4>
                                                        <h5 class="italic">Lorem ipsum dolar sit amet...</h5>
                                                    </div>
                                                    <div class="col-sm-3" style="border-left:1px solid #eeeeee">
                                                        <p><i class="fa fa-mobile"></i> &nbsp +1 234567890</p>
                                                        <p><i class="fa fa-envelope"></i> &nbsp victus.info7@gmail.com</p>
                                                        <p><i class="fa fa-map-marker"></i> &nbsp Waganese, 10201, Viena</p>
                                                    </div>
                                                </div>
                                                <div class="row m-heading-1 border-green m-bordered" id="2">
                                                    <div class="col-sm-2">
                                                        <img src="/images/avatar/avatar.png" class="legion-avatar">
                                                    </div>
                                                    <div class="col-sm-7">
                                                ...
                                                <div class="row m-heading-1 border-green m-bordered" id="3">
                                                    <div class="col-sm-2">
                                                        <img src="/images/avatar/avatar.png" class="legion-avatar">
                                                    </div>
                                                    <div class="col-sm-7">
